...
console.log(
   searchParamsURL('https://example.com/pathname?param1=value1&param2=value2&param3=value3'),
);
// Виведе
// Map(3) {
//   'param1' => 'value1',
...
console.log(
   manipulateSearchParams({ param1: 'value1', param2: 'value2' }, 'https://example.com/pathname'),
);
...
console.log(
   checkURLParameters('https://example.com/?param1=value1&param2=value2&param3=value3', params),
);
...
function getURLValues(url) {
   ...
   const values = [];
   for (const key of keys) {
      values.push(URLSearchParams.getAll(key));
   }
